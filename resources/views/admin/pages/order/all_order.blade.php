        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="" class="text-light btn btn-sm btn-dark mb-1" data-bs-toggle="modal"
                    ...
                    <table id="kt_datatable_example_5" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                            ...
                            @foreach ($orders as $key => $order)
                                <tr>
                                    <td>
                                        <input type="checkbox" autocomplete="off" class="order_checkbox"
                                            value="{{ $order->id }}">
                                    </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('multuOrderStatusUpdate') }}" method="POST" id="order_status_update_form">
                        @csrf

                        <label>Status</label>

                        <select class="form-control" name="status" autocomplete="off" id="multi_status" required>
                        ...
                        <button type="submit" class="btn btn-light-primary btn-sm  mt-4 float-end"> Submit</button>
