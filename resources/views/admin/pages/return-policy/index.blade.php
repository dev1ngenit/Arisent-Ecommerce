        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Return & Policy<span class="ms-2 badge bg-danger"></span></li>
                    <!--end::Item-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ route('admin.return-policy.create') }}" class="btn btn-light-primary btn-sm">Add
                    Return & Policy</a>
                    ...
                    @foreach ($items as $key => $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('delete.return', $item->id) }}" class=""
