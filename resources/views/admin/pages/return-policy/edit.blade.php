...
@section('admin')
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Return & Policy</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Return & Policy<span class="ms-2 badge bg-danger"></span>
                    </li>
                    <!--end::Item-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ route('admin.return-policy.create') }}" class="btn btn-light-primary btn-sm">Back</a>
    ...
    <div class="card card-flash">
        ...
        <div class="card-body">
            ...
            <form id="myForm" method="post" action="{{ route('admin.return-policy.update', $item->id) }}"
