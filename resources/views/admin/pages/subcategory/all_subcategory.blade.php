                    ...
                    @foreach ($subcategorys as $key => $subcategory)
                        <tr>
                            ...
                            <td>
                                ...
                                @if (Auth::guard('admin')->user()->can('status.subcategory'))
                                    @if ($subcategory->status == 1)
                                        <a href="{{ route('subcategory.inactive', $subcategory->id) }}" title="Inactive"><i
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <img src="{{ asset('storage/subcategory/' . $subcategory->subcategory_image) }}"
                                                                class="mt-3 showImageSrc" style="width: 73px;height:73px;"
                                                                alt="">
                                                        </div>
